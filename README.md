...
```
cd existing_repo
git remote add origin https://gitlab.com/davids_proj/crime-analysis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/davids_proj/crime-analysis/-/settings/integrations)
...
## Description
Using crime descriptions and tags, ML models will predict the crime code associated with such tags.
This is useful in quickly searching what section a crime falls under. Data is gotten from US 2020-2022
